...
namespace DataServices
{
    ...
    public class AdditionStepDefinitions
    {
        ...
        public void ThenTheTableOnTheWorkbenchShouldHaveOrderCountAggregatedAcrossOrders(TypedTable expectedRows)
        {
            var expectedResults = expectedRows.ToDictionaries().ToList();
            expectedResults.Sort(DictionariesComparator.CompareTo);
        ...
        public void ThenTheTableOnTheWorkbenchShouldHaveOrderCountAggregatedAcrossAccountsAndOrders(TypedTable expectedRows)
        {
            var expectedResults = expectedRows.ToDictionaries().ToList();
            expectedResults.Sort(DictionariesComparator.CompareTo);
